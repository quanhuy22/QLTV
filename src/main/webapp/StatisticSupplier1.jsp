...
<html lang="en">
    ...
    <body id="page-top">
        <%
            ...
            List<SupplierStat> supplierStat = (List<SupplierStat>) session.getAttribute("supplierStat");
        %>
        <!-- Page Wrapper -->
        <div id="wrapper">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <form class="ml-4 mt-2" action="doStatisticSupplierUI.jsp" method="post">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <%if (supplierStat != null) {
                                                    int stt = 0;
                                                    for (SupplierStat stat : supplierStat) {
                                                        stt++;
                                            %>
                                            <tr>
                                                <td><%=stt%></td>
                                                <td><a href="doViewImportedTimes.jsp?IDSupplier=<%= stat.getIDSupplier()%>"><%=stat.getNOSupplier()%></a></td>
                                                <td><%=stat.getIDSupplier()%></td>
                                                <td><%=stat.getImportedTime()%></td>
                                            </tr>
